...
* Update compatibility to WordPress 4.

= 2.2.1 =

* Update compatibility to WordPress 3.9.1.
...
* Update compatibility to WordPress 3.8.

= 2.0.9 =

* Update compatibility to WordPress 3.6.1.
...
* Bugfix: Categories drop-down was not properly rendered in Internet Explorer.
